...
class NewReleaseCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        artistNameLabel.frame = CGRect(x: albumCoverImageView.right+10, y: albumCoverImageView.bottom, width: contentView.width-albumCoverImageView.right-5, height: 30)
